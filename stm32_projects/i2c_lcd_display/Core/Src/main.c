...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  I2C_Scan();
  // Use the correct function names (with capital SSD1306_)
  if (SSD1306_Init() != 1) {
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	 /*if (1) {
		 ssd1306_Fill(0);
		 ssd1306_WriteString("O B J E C T   I S", 5, 20, Font_7x10);
		 ssd1306_WriteString("I N   R A N G E", 15, 35, Font_7x10);
		 ssd1306_UpdateScreen(&hi2c1);
		 HAL_Delay(500);
	 } else {
		 ssd1306_Fill(0);
		 ssd1306_WriteString("NO OBJECT", 15, 20, Font_7x10);
		 ssd1306_WriteString("DETECTED", 20, 35, Font_7x10);
		 ssd1306_UpdateScreen(&hi2c1);
		 HAL_Delay(500);
	 }*/
  }
