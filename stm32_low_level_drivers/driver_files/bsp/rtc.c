...
void ds1307_set_current_time(RTC_time_t* rtc_time)
{
	...
	ds1307_write(binary_to_bcd(rtc_time->minute), DS1307_ADDR_MIN);
...
static void ds1307_i2c_pin_config(void)
{
	...
	i2c_sda.GPIO_PinConfig.GPIO_PinSpeed = GPIO_HIGH_SPEED;
	...
	i2c_scl.GPIO_PinConfig.GPIO_PinSpeed = GPIO_HIGH_SPEED;
...
{
	uint8_t data;
	I2C_MasterSendData(&g_ds1307I2cHandle, reg_addr, 2, DS1307_I2C_ADDRESS);
